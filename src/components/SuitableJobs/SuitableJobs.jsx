...
const SuitableJobs = ({ bestJobs }) => {
  ...
  const formatSalary = (salary) => {
    return salary ? `Tới ${salary.toLocaleString()} VND` : 'Lương thỏa thuận';
  };
                  ...
                  <div className='ml-5 flex-1'>
                    ...
                    <div className='ml-auto space-x-3 mt-3 flex justify-end'>
                      <button
                        ...
                        className='bg-green-500 text-white font-bold text-sm h-8 px-4 rounded-md'>
                        Ứng tuyển
                      </button>
                      <button
                        onClick={() => handleFavoriteClick(job.id)}
                        className='bg-green-100 h-8 w-8 flex items-center justify-center rounded-md'>

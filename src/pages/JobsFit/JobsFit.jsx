    ...
    useEffect(() => {
        ...
        const getCvsData = async () => {
            ...
            if (!response.error) {
                ...
                console.log("Error fetching CVs:", response.error);
                setHasCV(false);
            }
        };
    ...
    useEffect(() => {
        ...
        const fetchBestJobs = async () => {
            ...
            if (response.data) {
                ...
                console.log("Error finding best jobs:", response.error);
            }
        };
                        ...
                        {!hasCV ? (
                            <div className="p-8 bg-white rounded-xl shadow text-center">
                                <h2 className="text-2xl font-semibold mb-4">
                                    Bạn chưa có CV nào. Vui lòng tải lên CV để sử dụng tính năng gợi ý công việc.
                                </h2>
                            </div>
                        ) : isPremium ? (
